...
Common labels
*/}}
{{- define "helm-rabbitmq.labels" -}}
helm.sh/chart: {{ include "helm-rabbitmq.chart" . }}
{{ include "helm-rabbitmq.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "helm-rabbitmq.selectorLabels" -}}
app.kubernetes.io/name: {{ include "helm-rabbitmq.name" . }}
...
*/}}
{{- define "helm-rabbitmq.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "helm-rabbitmq.fullname" .) .Values.serviceAccount.name }}
{{- else }}
